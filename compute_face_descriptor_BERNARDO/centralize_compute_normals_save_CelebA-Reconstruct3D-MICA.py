...
def parse_args():
    ...
    parser.add_argument("-dataset_path", type=str, default='/home/bjgbiesseck/GitHub/MICA/demo/output/CelebA/Img/img_align_celeba', help='')
...
# BERNARDO
class TreeCelebA_3DReconstructedMICA:
...
def main_centralize_nosetip_with_normals(args):
    ...
    pc_paths, kp_paths = TreeCelebA_3DReconstructedMICA().get_all_pointclouds_paths(args.dataset_path, args.input_pc_ext, args.input_kp_ext)
...
if __name__ == '__main__':
    ...
    if not '-dataset_path' in sys.argv:
        sys.argv += ['-dataset_path', '/home/bjgbiesseck/GitHub/MICA/demo/output/CelebA/Img/img_align_celeba']
