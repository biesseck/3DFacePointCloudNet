...
def parse_args():
    ...
    parser.add_argument("-dataset_path", type=str, default='/home/bjgbiesseck/GitHub/BOVIFOCR_MICA_3Dreconstruction/demo/output/MLFW/origin', help='')
...
# BERNARDO
class TreeMLFW_3DReconstructedMICA:

    def get_all_sub_folders(self, dir_path='', dir_level=2):
        return sorted(glob(dir_path + '/*'*dir_level))

    def get_all_pointclouds_paths(self, dir_path, dir_level=2, pc_ext='.ply', kp_ext='kpt68.npy'):
...
def main_centralize_nosetip_with_normals(args):
    ...
    pc_paths, kp_paths = TreeMLFW_3DReconstructedMICA().get_all_pointclouds_paths(args.dataset_path, args.dir_level, args.input_pc_ext, args.input_kp_ext)
...
if __name__ == '__main__':
    ...
    if not '-dataset_path' in sys.argv:
        sys.argv += ['-dataset_path', '/home/bjgbiesseck/GitHub/BOVIFOCR_MICA_3Dreconstruction/demo/output/MLFW/origin']

    sys.argv += ['-dir_level', '1']
