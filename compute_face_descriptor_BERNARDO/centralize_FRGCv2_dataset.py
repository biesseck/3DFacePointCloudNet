...
def parse_args():
    ...
    parser.add_argument('-output_pc_ext', type=str, default='*.xyz', help='')
...
def detect_nose_landmarks(detector, imgRGB):
    ...
    # imgRGB_with_landmark = cv2.circle(imgRGB.copy(), nose, radius=3, color=(0, 0, 255), thickness=-1)
...
def save_normalized_point_cloud(ptcloud_centralized, path_centralized_ptcloud):
    pcl.sa
